...
//  Furniture_app
//
//  Created by Arun Rathore on 30/08/22.
//
...
struct BottomNavBarView: View {
  var body: some View {
    HStack {
      BottomNavBarItem(image: Image("SF_house_fill"), action: {})
      BottomNavBarItem(image: Image("SF_suit_heart_fill"), action: {})
      BottomNavBarItem(image: Image("SF_ellipsis_circle"), action: {})
